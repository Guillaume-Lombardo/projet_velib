...
stations_sirene_voronoi500 <- read.csv("C:/Users/tix/Desktop/stations_sirene_voronoi500.csv")[,-1]
stations_sirene_voronoi100 <- read.csv("C:/Users/tix/Desktop/stations_sirene_voronoi100.csv")[,-1]
stations_sirene_cercle500 <- read.csv("C:/Users/tix/Desktop/stations_sirene_cercle500.csv")[,-1]
stations_sirene_cercle500 <- merge(stations,stations_sirene_cercle500)
stations_sirene_cercle100 <- read.csv("C:/Users/tix/Desktop/stations_sirene_cercle100.csv")[,-1]
stations_sirene_cercle100 <- merge(stations,stations_sirene_cercle100,all=T)
stations_sirene_cercle100[,][is.na(stations_sirene_cercle100[,])] <- 0
stations_population_voronoi500 <- read.csv("C:/Users/tix/Desktop/stations_population_voronoi500.csv")[,-1]
stations_population_voronoi500 <- merge(stations,stations_population_voronoi500)
stations_population_voronoi100 <- read.csv("C:/Users/tix/Desktop/stations_population_voronoi100.csv")[,-1]
stations_population_voronoi100 <- merge(stations,stations_population_voronoi100)
stations_population_cercle500 <- read.csv("C:/Users/tix/Desktop/stations_population_cercle500.csv")[,-1]
stations_population_cercle500 <- merge(stations,stations_population_cercle500)
stations_population_cercle100 <- read.csv("C:/Users/tix/Desktop/stations_population_cercle100.csv")[,-1]
